...
/**
 * @file
 * Defines Drupal\charts\Plugin\views\field\ScatterFieldPlus.
 */

/**
 * Field handler to provide x and y values for a scatter chart, plus a bonus field to be used elsewhere.
 *
 * @ingroup views_field_handlers
 * @ViewsField("field_charts_fields_scatter_plus")
 */
class ScatterFieldPlus extends FieldPluginBase implements ContainerFactoryPluginInterface {
  ...
  protected function defineOptions() {
    ...
    $this->field_alias = 'scatter_plus_field';
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    unset($fieldList['field_charts_fields_scatter_plus']);
  ...
  protected function getFieldValue(ResultRow $values, $fieldset, $axis) {
    ...
    if (isset($this->view->field[$field])) {
      if ($field == 'scatter_plus_field') {
        $data = $this->view->field['field_charts_fields_scatter_plus']->getValue($values);
      }
      else {
